...
//    }
    ...
    public String view(
        ...
        TravelLogContent travelLogContent = travelLogContentService.get(no);
        if (travelLogContent == null) {
            throw new Exception("유효하지 않은 게시물 번호입니다.");
        }
        map.put("travelLogContent", travelLogContent);
        return "travelLogContent/view";
    }
