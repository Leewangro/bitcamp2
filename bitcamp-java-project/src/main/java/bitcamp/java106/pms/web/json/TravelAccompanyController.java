...
public class TravelAccompanyController {
    
    TravelAccompanyService travelAccompanyService;
    
    public TravelAccompanyController(TravelAccompanyService travelAccompanyService) {
        this.travelAccompanyService = travelAccompanyService;
    }
    ...
    public Object list(
        ...
        return travelAccompanyService.list(pageNo, pageSize);
    }
