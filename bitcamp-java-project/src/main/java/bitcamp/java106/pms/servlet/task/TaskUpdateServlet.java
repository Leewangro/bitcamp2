...
public class TaskUpdateServlet extends HttpServlet {
    ...
    protected void doPost(
        ...
        System.out.println(new Team().setName(request.getParameter("teamName")));
        System.out.println(new Member().setId(request.getParameter("memberId")));
