...
app.get('/auth/logout', function(req, res){
    req.logout();
    request('http://tamlaisjeju.java106.com:8888/bitcamp-java-project/json/auth/logout');
    console.log('로그아웃완료');
    res.redirect("http://tamlaisjeju.java106.com:8888/bitcamp-java-project/tamlaisjeju/index2.html");
});
...
app.get('/auth/facebook/callback',
    ...
    (req, res) => {
     ...
     //   console.log(req);
        ...
        request(`http://tamlaisjeju.java106.com:8888/bitcamp-java-project/json/auth/facebookLogin?accessToken=${fbAccessToken}`,{ json: true }, (err, resp, body) => {
...
app.get('/auth/is', (req, res) => {
    request("http://tamlaisjeju.java106.com:8888/bitcamp-java-project/json/auth/islogin"), {json:true}, (err, resp, body) => {
        console.log(body);
    }   
})
...
app.get('/auth/kakao/callback',
    passport.authenticate('kakao', 
        ...
        (req,res) => {
            ...
            // 8888 서버에 요청하기
        request(`http://tamlaisjeju.java106.com:8888/bitcamp-java-project/json/auth/kakaoLogin?accessToken=${kaAccessToken}`,{ json: true }, (err, resp, body) => {
            console.log("8888 서버에서 응답이 왔음!")
            if (body.status === "success") {
                console.log(body);
                res.redirect("http://tamlaisjeju.java106.com:8888/bitcamp-java-project/tamlaisjeju/index2.html");
